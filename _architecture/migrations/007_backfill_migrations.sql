...
INSERT INTO membership_roles (workspace_id, membership_id, role_id, is_primary, assigned_at, created_at)
SELECT
    wm.workspace_id,
    wm.id,
    COALESCE(
...
FROM workspaces w
CROSS JOIN (VALUES
    ('Annual Leave', 'ANNUAL', 'Paid annual leave (vacation)', 'yearly', 21.00, NULL, TRUE, TRUE, FALSE, FALSE, 1),
    ('Sick Leave', 'SICK', 'Paid/unpaid sick leave with documentation', 'yearly', 14.00, NULL, FALSE, TRUE, TRUE, TRUE, 2),
    ('Unpaid Leave', 'UNPAID', 'Leave without pay', 'none', 0.00, NULL, FALSE, FALSE, FALSE, FALSE, 3),
    ('Maternity Leave', 'MATERNITY', 'Maternity leave as per labor law', 'none', 0.00, NULL, FALSE, TRUE, TRUE, FALSE, 4),
    ('Paternity Leave', 'PATERNITY', 'Paternity leave', 'none', 0.00, NULL, FALSE, TRUE, FALSE, FALSE, 5),
    ('Emergency Leave', 'EMERGENCY', 'Emergency/compassionate leave', 'none', 0.00, NULL, FALSE, TRUE, FALSE, TRUE, 6)
