    ...
    return SingleChildScrollView(
      ...
      child: Center(child: ConstrainedBox(constraints: const BoxConstraints(maxWidth: 600),
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Wrap(spacing: 10, runSpacing: 10, children: _primaries.map((c) => _Dot(color: c, sel: b.primaryColor == c, onTap: () => state.setPrimaryColor(c))).toList()),
          const SizedBox(height: AppSpacing.xl),
          Text(tr(context, 'brand_accent'), style: AppTypography.labelLarge),
          const SizedBox(height: AppSpacing.sm),
          Wrap(spacing: 10, runSpacing: 10, children: _accents.map((c) => _Dot(color: c, sel: b.accentColor == c, onTap: () => state.setAccentColor(c))).toList()),
          const SizedBox(height: AppSpacing.xl),
