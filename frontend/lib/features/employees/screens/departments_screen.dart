// SmartBiz AI — Departments management screen (backend-backed).
              ...
              Row(
                children: [
                  ...
                  FilledButton.icon(
                    ...
                    label: Text(tr(context, 'org_add_dept')),
            ...
            children: [
              TextField(
                ...
                decoration: InputDecoration(
                  labelText: tr(context, 'org_dept_name'),
              ...
              onPressed: saving
                  ...
                  : () async {
                      ...
                      if (err != null) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(tr(context, 'org_dept_created')),
      ...
      children: [
        ...
        Row(
          children: [
            _InfoChip(
              icon: Icons.groups,
              label: '${teams.length} ${tr(context, 'org_teams')}',
              color: AppColors.accent,
            ),
            const SizedBox(width: AppSpacing.sm),
            _InfoChip(
              icon: Icons.people,
              label: '${dept.memberCount} ${tr(context, 'org_members')}',
            ...
            if (dept.manager != null)
              _InfoChip(
                ...
                label: dept.manager!.fullName,
                color: AppColors.success,
              )
            else
              _InfoChip(
                icon: Icons.person_off,
                label: tr(context, 'org_no_manager'),
            ...
            (t) => Padding(
              ...
              child: Row(
                children: [
                  ...
                  Icon(Icons.groups_2, size: 14, color: AppColors.accent),
                  const SizedBox(width: 4),
            ...
            FilledButton(
              onPressed: saving
                  ...
                  : () async {
                      if (nameC.text.trim().isEmpty) return;
                      setD(() => saving = true);
                      final err = await state.editDept(
                        dept.id,
                        name: nameC.text.trim(),
                      ...
                      if (err != null) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
                            content: Text(tr(context, 'org_dept_saved')),
                            backgroundColor: AppColors.success,
                            behavior: SnackBarBehavior.floating,
                            shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(10),
      ...
      builder: (ctx) => AlertDialog(
        ...
        actions: [
          ...
          FilledButton(
            onPressed: () async {
              Navigator.pop(ctx);
              final err = await state.deleteDept(dept.id);
              ...
              if (err != null) {
                ...
                ScaffoldMessenger.of(context).showSnackBar(
                  SnackBar(
                    content: Text(tr(context, 'org_dept_deleted')),
                    backgroundColor: AppColors.error,
                    behavior: SnackBarBehavior.floating,
                    shape: RoundedRectangleBorder(
                      borderRadius: BorderRadius.circular(10),
