...
class AppTopBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  const AppTopBar({super.key, required this.title, this.onMenuTap});
  ...
  Widget build(BuildContext context) {
    ...
    final currentLang = context.select<AppState, AppLanguage>(
      (s) => s.uiLanguage,
    );
      ...
      child: Row(
        children: [
          ...
          _LangToggle(
            ...
            onTap: () {
              final newLang = currentLang == AppLanguage.en
                  ? AppLanguage.ar
                  : AppLanguage.en;
          ...
          PopupMenuButton<String>(
            ...
            child: CircleAvatar(
              ...
              child: Text(
                context.read<AppState>().currentUser.fullName.isNotEmpty
                    ? context.read<AppState>().currentUser.fullName[0]
                    : 'U',
              ...
              return [
                PopupMenuItem(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        as0.currentUser.fullName,
                        style: AppTypography.labelLarge,
                      ),
                      Text(
                        as0.currentUser.email,
                      ...
                      Container(
                        ...
                        child: Text(
                          as0.currentRole.id.toUpperCase(),
                          style: const TextStyle(
                            fontSize: 10,
                            fontWeight: FontWeight.w600,
                            color: AppColors.primary,
  ...
  Future<void> _handleLogout(BuildContext context) async {
    // Clear session-sensitive state before auth state is cleared
    try {
    ...
    try {
      ...
      // ApprovalState might not be mounted yet
    }
    try {
        ...
        content: Column(
          ...
          children: [
            _NotifTile(
              ...
              titleKey: 'ux_notif_stock',
              subtitleKey: 'ux_notif_stock_desc',
            ),
            _NotifTile(
              icon: Icons.receipt_long,
              color: AppColors.primary,
              titleKey: 'ux_notif_invoice',
              subtitleKey: 'ux_notif_invoice_desc',
            ),
            _NotifTile(
              icon: Icons.auto_awesome,
              color: AppColors.accent,
              titleKey: 'ux_notif_ai',
              subtitleKey: 'ux_notif_ai_desc',
            ),
          ],
        ),
        actions: [
          TextButton(
            ...
            child: Text(tr(context, 'ux_close')),
          ),
        ],
      ),
    );
