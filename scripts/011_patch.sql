...
-- ==========================================
-- SKIPPED: Migration 008 renamed these columns to _deprecated (workspace_id_deprecated,
-- role_id_deprecated, permissions_deprecated). The original column names no longer exist.
-- Deprecation comments were already applied by migration 006 and 008.
--
